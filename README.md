...
|---------|-------------|--------|
| Core — AI-powered foundation for ads workflows | Core foundation — the primary abstraction this repo builds on | [docs](#) |
| Execution — task decomposition and ads routing | Execution layer — how tasks get decomposed and routed | [docs](#) |
| Integration — Claude Code + creative connectivity | Integration layer — connecting to external tools and APIs | [docs](#) |
...
```bash
# Quick start
python3 main.py --task "ads task here"

# Power user shortcut
python3 main.py --ads --fast
...
Use ads-creative to automate ai-powered ad creative generation and testing. Perfect for agencies, freelancers, and AI-first teams running ads workflows at scale.
...
```bash
# Add to CLAUDE.md
echo "Auto-activate: ads, creative" >> ~/.claude/CLAUDE.md

# Or load skill directly
/load-skill ads-creative
```
...
{
  "hooks": {
    "PostToolUse": [{"matcher": "ads", "command": "python3 ~/repos/ads-creative/main.py"}]
  }
}
```
...
```bash
# Fork and clone
gh repo fork hmzainjamil/ads-creative --clone
cd ads-creative
